if _G.ASM_CVARS_LOADED then
	return
end

_G.ASM_CVARS_LOADED = true
...
Convar(
	...
	"Movement speed multiplier during the aiming sequence",
	"float",
	0.01,
	8,
	2
...
Convar(
	cg,
	false,
	"ttt_asm_mouse_speed_modifier",
	3,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Speed multiplier applied to the mouse movement",
	"float",
	0.01,
	12,
	2
...
Convar(
	...
	15,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"How much time do you have to aim the missile",
	"float",
	1,
	300,
	1
...
Convar(
	cg,
	false,
	"ttt_asm_missile_blast_damage",
	110,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Damage of the missile blast",
	"int",
	1,
	3000
)
Convar(
	cg,
	false,
	"ttt_asm_missile_blast_radius",
	384,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Radius of the missile blast",
	"int",
	100,
	5000
)
Convar(
	...
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Allows you to abort the aiming sequence",
	"bool"
)
Convar(
	cg,
	false,
	"ttt_asm_allow_abort_mid_flight",
	0,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Allows you to move the camera after the missile was launched (At the end of the aiming sequence)",
	"bool"
)
Convar(
	cg,
...
Convar(
	cg,
	false,
	"ttt_asm_damage_owner",
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Should the missile damage its owner",
	"bool"
)
Convar(
	cg,
	false,
	"ttt_asm_friendlyfire",
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Should the missile damage the owners teammates",
	"bool"
)
Convar(
	cg,
...
Convar(
	cg,
	false,
	"ttt_asm_explosion_respect_walls",
	1,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Whether the explosion damage respects world geometry (line of sight checks)",
	"bool"
)
Convar(
	cg,
	false,
	"ttt_asm_explosion_wallcheck_samples",
	6,
	{ FCVAR_ARCHIVE, FCVAR_NOTIFY, FCVAR_REPLICATED },
	"Line of sight sample count per target (0 disables checks; 1/3/6 supported)",
	"int",
	0,
	6
)
